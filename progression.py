...
def _load_step(sessions: dict[str, list[dict]]) -> float | None:
    ...
    the larger of 8kg and 6% of the load: the Machine Chest Press stack moves
    in 8kg (85, 93, ... 141, 149, 165) and a 5kg/5% cap threw that out at
    149, so week 1 opened at 151.5kg, a load the machine does not have; a
    10kg cap took a two-session 75 -> 85 gap on the Lat Pulldown as one step
    and proposed 95 when 90 exists (replay of the 23 Sep 2026 export).
