<!-- generated 2026-09-14 · 441 prescriptions · 50 violations -->

**Protocol audit — last 90 days**

- **441** prescriptions checked across **2124** replies on dated training days.
- **43** of them broke at least one rule.
- Week known for 294 prescriptions (257 from the coach's own words that day, 37 from the session stamp): every check ran. Week only reconstructed for 147: set count and back-off shape checked, RPE and rep range not judged. Where the coach stated the week, the rotation walk agreed 14 of 40 days.
