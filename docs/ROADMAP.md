...
- **Approved, 15 Sep.** 2.3 rep-overshoot step sizing (shipped #249);
  2.4 Swift tests for the numbers **(shipped and verified 18 Sep: 31 tests, six files, all green)**; 2.7 export **(shipped 16 Sep, #254; verified 17 Sep — five CSVs came back and settled the hamstring question)**; 2.8 Apple Watch, staged, mockups first;
