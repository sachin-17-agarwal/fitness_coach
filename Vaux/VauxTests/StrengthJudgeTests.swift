...
struct StrengthJudgeTests {
    ...
    @Test func aClearRiseReadsUpOrPR() {
        ...
        let report = LiftReport.judge(name: "Leg Press", byPos: pts, block: 0, sessionType: "Legs")
    ...
    @Test func aStandingDecisionReadsHeldNotDrop() {
        ...
        let report = LiftReport.judge(name: "Machine Shoulder Press", byPos: pts, block: 0, sessionType: "Push", held: cap)
    ...
    @Test func aBuildWeekBestIsNoVerdictUntilThePeakIsLifted() {
        ...
        let report = LiftReport.judge(name: "Leg Press", byPos: pts, block: 0, sessionType: "Legs", peakLifted: false)
        #expect(report.state == StrengthState.none)
    }
}
