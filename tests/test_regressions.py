...
class ProgrammeShadowModeTests(unittest.TestCase):
    ...
    def test_only_the_named_editing_steps_may_rebind_the_reply(self):
        ...
        self.assertEqual([n for n, _ in STEPS],
                         ["truncation", "numbers", "set_counts", "rest_floor", "warmup_ramp", "plan_follows", "revise_claim", "weak_points",
                          "programme_live", "decisions", "captures"])
        self.assertEqual(set(EDITING_STEPS), {"numbers", "set_counts", "rest_floor", "warmup_ramp", "revise_claim", "weak_points", "programme_live"})
